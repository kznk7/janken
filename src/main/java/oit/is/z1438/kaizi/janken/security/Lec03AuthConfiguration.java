...
public class Lec03AuthConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("ながたに")
        .password("$2y$10$nh3Jvl2XII41owgDfKhtCuYt02ei/oJ0aMGMho8TQgBPA2YrQiV3y").roles("USER");
    auth.inMemoryAuthentication().withUser("たろう")
        .password("$2y$10$QMGg2DiReM9ykevdFyCeTOlBJ8mnJykXSCeXBZ/V43s4Tpc7srKu6").roles("USER");
  }
